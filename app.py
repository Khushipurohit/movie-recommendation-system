...
with mid:
       st.image('https://o.remove.bg/downloads/8713b3d1-e0b0-456b-b149-801ff2fbcd15/big-open-clapper-board-movie-reel-cinema-icon-set-movie-film-elements-flat-design-cinema-movie-time-flat-icons-f-95500226-removebg-preview.png', width = 200)
...
if choice == 'ABOUT PROJECT':
    ...
    with col1:
        st.sidebar.image('https://o.remove.bg/uploads/d2688c3b-dc9e-4698-b7d3-9019f37c008c/IMG_20220529_092154.jpg',width= 200)
